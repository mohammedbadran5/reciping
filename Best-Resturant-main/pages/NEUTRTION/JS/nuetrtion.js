...
function generateHTML(results) {
    ...
    results.forEach((result) => {
        ...
        let heartIconClass = ""; // Determine initial class based on user preference
        // Example: check if user has already liked this recipe and change class accordingly
        ...
        <div class="col-12 col-md-6 col-xl-4 col-lg-4">
            <div class="card card__main">
                ...
                <a href="${result.recipe.url}" target="_blank" class="btn btn-primary" rel="noopener" tabindex="0">See Recipe</a>
            </div>
        </div>`;
    });
}
...
function toggleHeartIcon(icon, recipeLabel) {
    if (!icon.classList.contains('liked')) {
        ...
        // Already liked, display error message
